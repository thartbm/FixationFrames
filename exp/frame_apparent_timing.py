...
def doDotTrial(cfg):
    ...
    while waiting_for_response:
        ...
        if cfg['expno'] in [2,3]:
            if (tt - trial_start_time) > (p * 2):
                reaction_time = 0
                waiting_for_response = False

        # on every frame:
        this_frame_time = tt - trial_start_time
        ...
        # flash any dots?
        if ( ((t + (1/30) - (framelag/30)) % (2*p)) < (1.99/30)):
            flash_red = True
        if ( ((t + (1/30) + p - (framelag/30)) % (2*p)) < (1.99/30) ):
            flash_blue = True

        # # flash frame for apparent motion frame:
        # if ( ((t + (1/30)) % (p/1)) < (3.99/30)):
        #     flash_frame = True
    ...
    # period + (pauseframes/30) # should have been 4???
    # d = (distance/period) * p

    filename = '%st%d_F%s_MD%0.3f_PD%0.3f_FL%0.1f.csv'%(cfg['datadir'],cfg['currenttrial'],trialdict['stimtype'],period,pauseframes/30,framelag)

    pd.DataFrame({'time':frame_times,
                    'frameX':frame_pos_X,
                    'blue_flashed':blue_on,
                    'red_flashed':red_on,
                    'frame_on':frame_on}).to_csv(filename, index=False)
    # else:
    #     response                = trialdict
...
def getTasks(cfg):
    ...
    if cfg['expno']==1:
        ...
        condictionary = [
                         ...
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 2},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 3},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 4},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 5},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 6},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 7},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 8},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 9},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 10},
                         {'period':0.30, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 11},
                         
                         # alternative amplitudes:
                         {'period':0.30, 'amplitude':3, 'stimtype':'classicframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':2, 'stimtype':'classicframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':1, 'stimtype':'classicframe', 'framelag': 0},

                         # apparent frame with the same 10 lags as before
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 2},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 3},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 4},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 5},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 6},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 7},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 8},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 9},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 10},
                         {'period':0.30, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 11},

                         # apparent frame with alternative amplitudes:
                         {'period':0.30, 'amplitude':3, 'stimtype':'apparentframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':2, 'stimtype':'apparentframe', 'framelag': 0},
                         {'period':0.30, 'amplitude':1, 'stimtype':'apparentframe', 'framelag': 0}
    ...
    if cfg['expno']==2:
        ...
        condictionary = [
                         ...
                         # classic frame with 10 lags
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 0, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 2, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 3, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 4, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 5, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 6, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':4, 'stimtype':'classicframe', 'framelag': 7, 'pauseframes':4},
                         
                        #  # alternative amplitudes:
                        #  {'period':0.20, 'amplitude':3, 'stimtype':'classicframe', 'framelag': 0, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':2, 'stimtype':'classicframe', 'framelag': 0, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':1, 'stimtype':'classicframe', 'framelag': 0, 'pauseframes':4},

                         # apparent frame with the same 10 lags as before
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 0, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 2, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 3, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 4, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 5, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 6, 'pauseframes':4},
                         {'period':0.20, 'amplitude':4, 'stimtype':'apparentframe', 'framelag': 7, 'pauseframes':4},

                        #  # apparent frame with alternative amplitudes:
                        #  {'period':0.20, 'amplitude':3, 'stimtype':'apparentframe', 'framelag': 0, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':2, 'stimtype':'apparentframe', 'framelag': 0, 'pauseframes':4},
                        #  {'period':0.20, 'amplitude':1, 'stimtype':'apparentframe', 'framelag': 0, 'pauseframes':4}
...
def getParticipant(cfg, ID=None, check_path=True):
    ...
    if check_path:
        ...
        for thisPath in ['../data', '../data/apparent_timing', '../data/apparent_timing/exp_%d'%(cfg['expno']), '../data/apparent_timing/exp_%d/%s'%(cfg['expno'],cfg['ID'])]:
            # print(' - %s'%(thisPath))
            if os.path.exists(thisPath):
                if not(os.path.isdir(thisPath)):
                    # os.makedirs
                    ...
                    if (thisPath == '../data/apparent_timing/exp_%d/%s'%(cfg['expno'],cfg['ID'])):
                        # sys.exit('participant already exists (crash recovery not implemented)')
    ...
    cfg['datadir'] = '../data/apparent_timing/exp_%d/%s/'%(cfg['expno'],cfg['ID'])
